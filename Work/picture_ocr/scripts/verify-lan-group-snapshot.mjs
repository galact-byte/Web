...
fixture.group = { id: 'g', projectName: '已保存组名' };
...
console.log('PASS group snapshot: authoritative names, rename, explicit membership, empty/single/independent/missing groups and read failure');
