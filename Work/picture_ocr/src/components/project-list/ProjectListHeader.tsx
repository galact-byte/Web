...
const ProjectListHeader: React.FC<ProjectListHeaderProps> = ({
  ...
  return (
    <header className="border-b border-slate-200 bg-white/95 px-8 py-3 backdrop-blur">
      <div className="flex items-center justify-between gap-6">
        ...
        <div className="flex min-w-0 items-center gap-3">
          <label className="flex h-10 w-[320px] items-center border border-slate-300 bg-slate-50 px-3 text-slate-500 focus-within:border-blue-400 focus-within:bg-white">
          ...
          <button
            ...
            className="inline-flex h-10 min-w-[108px] items-center justify-center gap-2 border border-slate-300 bg-white px-3 text-sm text-slate-700 transition-colors hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-300"
            title="勾选项目后批量删除"
          >
          ...
          <button
            ...
            className="inline-flex h-10 min-w-[108px] items-center justify-center gap-2 border border-blue-300 bg-blue-50 px-3 text-sm font-medium text-blue-700 transition-colors hover:bg-blue-100"
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
